...
export const OMNI_API_CONTRACTS: OmniApiContract[] = [
  ...
  { id: 'content-validator-read', path: '/api/v1/models/:param/content-validator', methods: ['GET'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: API_INDEX, probeMode: 'read_only' },
