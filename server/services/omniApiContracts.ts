...
export const OMNI_API_CONTRACTS: OmniApiContract[] = [
  ...
  { id: 'documents-list', path: '/api/v1/documents', methods: ['GET'], status: 'documented_current', workflows: ['dashboard_migrator', 'dashboard_operations', 'deck_builder'], docsUrl: 'https://docs.omni.co/api/documents/list-documents', probeMode: 'read_only' },
