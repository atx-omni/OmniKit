...
export const OMNI_API_CONTRACTS: OmniApiContract[] = [
  ...
  { id: 'ai-job-result', path: '/api/v1/ai/jobs/:param/result', methods: ['GET'], status: 'documented_current', workflows: ['semantic_studio', 'bi_migration_studio', 'ai_content_studio'], docsUrl: 'https://docs.omni.co/api/ai/stream-ai-job-results', probeMode: 'read_only' },
  ...
  { id: 'models-list', path: '/api/v1/models', methods: ['GET'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: API_INDEX, probeMode: 'read_only' },
  { id: 'models-create', path: '/api/v1/models', methods: ['POST'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: API_INDEX, probeMode: 'controlled_write' },
  ...
  { id: 'content-validator-read', path: '/api/v1/models/:param/content-validator', methods: ['GET'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio', 'ai_content_studio'], docsUrl: 'https://docs.omni.co/api/content-validator/validate-content', probeMode: 'read_only' },
  { id: 'content-validator-run', path: '/api/v1/models/:param/content-validator', methods: ['POST'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: API_INDEX, probeMode: 'manual_only', notes: 'Operation-specific entry: POST runs validation but is never categorized as a read-only readiness probe.' },
  ...
  { id: 'model-yaml-read', path: '/api/v1/models/:param/yaml', methods: ['GET'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: 'https://docs.omni.co/api/models/get-model-yaml', probeMode: 'read_only' },
  { id: 'model-yaml-write', path: '/api/v1/models/:param/yaml', methods: ['POST'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: 'https://docs.omni.co/api/models/create-or-update-yaml-files', probeMode: 'controlled_write' },
  { id: 'model-yaml-delete', path: '/api/v1/models/:param/yaml', methods: ['DELETE'], status: 'documented_current', workflows: ['dashboard_migrator', 'model_migrator', 'semantic_studio', 'bi_migration_studio'], docsUrl: 'https://docs.omni.co/api/models/delete-a-yaml-file', probeMode: 'controlled_write' },
