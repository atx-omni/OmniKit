- dashboard: whata_dashboard
  title: "WhataDashboard"
  layout: newspaper
  ...
  - name: location_performance
    ...
    explore: daily_grill_report
    type: looker_bar
    fields: [whataburger_locations.location_name, whataburger_locations.territory, daily_grill_report.total_revenue]
