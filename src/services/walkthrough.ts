...
export const walkthroughSteps: WalkthroughStep[] = [
  ...
  },
  {
    ...
    directions: [
      ...
      'Review structural and semantic validation plus query, visual, governance, operational, and owner-acceptance evidence. Unsupported or unrun checks remain unverified and require an explicit waiver or owner-assigned disposition before sign-off.',
