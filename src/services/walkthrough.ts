...
export const walkthroughSteps: WalkthroughStep[] = [
  ...
  },
  {
    ...
    outcome: 'Dashboard migration work becomes a reviewed, retryable copy/import job with clear route paths, field/query-view/relationship/topic dependency prep, folder placement, target replacement, metadata preservation, schema refresh, and source cleanup.',
