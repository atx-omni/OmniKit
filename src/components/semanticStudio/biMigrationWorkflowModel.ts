...
export type BiMigrationWorkflowStepId = 'source' | 'evidence' | 'destination' | 'analyze' | 'place' | 'resolve' | 'validate' | 'build';
...
export const BI_MIGRATION_WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  { id: 'place', label: 'Place', description: 'Decide which logic belongs upstream, in the Omni model, in a topic, or in a governed handoff.', icon: Route },
